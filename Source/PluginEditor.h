 ...
 *   - Large animated ADSR envelope curve displays
 *   - Filter response curve visualization
 *   - Mini waveform previews per oscillator
 *   - Dedicated FX and Macro sections
...
private:
    ...
    // --- Animated ADSR envelope curve display ---
    ...
    // --- Filter response curve (LP/HP/BP/Notch) ---
    class FilterCurveDisplay : public juce::Component
    {
    public:
        FilterCurveDisplay() = default;
        void paint (juce::Graphics&) override;
        void setParams (int type, float cutoff, float reso);
    private:
        int   filterType   = 0;  // 0=LP4, 1=LP2, 2=HP4, 3=HP2, 4=BP, 5=Notch
    ...
    static constexpr int kPanelPad = 30;
